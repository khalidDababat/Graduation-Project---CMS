    ...
    <footer className={styles.footer}>
      <div className={styles.container_footer}>
        <div className={styles.footer_item}>
          ...
          <p>
            يتطلع نظام إدارة الشكاوى لبلدية عنبتا إلى تقديم خدمة بلدية إلكترونية
            فعالة، تضمن سرعة الاستجابة، ورفع جودة المتابعة، وتعزيز الشفافية في
            معالجة الشكاوى.
          </p>
          </div>
          ...
          <div className={styles.social_icons}> 
            ...
            <div>
              <Link  className={styles.logInEmoloyees} to='/loginAdmin'>تسجيل دخول الموظفين</Link>
            </div>
